...
<head>
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/slick.css" />
	<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ); ?>/slick-theme.css"  />
	<script type="text/javascript" src="<?php bloginfo( 'template_url' ); ?>/scripts/jquery-2.1.4.min.js"></script>
	<script type="text/javascript" src="<?php bloginfo( 'template_url' ); ?>/scripts/slick.min.js"></script>
	...
	?>
		<?php
			...
			<div id="header-image" class="container">
				<img src="<?php header_image(); ?>" width="100%" alt="<?php bloginfo('name'); ?>" />
			</div><!--#header-image-->
